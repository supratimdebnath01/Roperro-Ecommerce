            ...
            <div class="container">
                <div class="row">
                    <div class="tc-heading">
                        ...
                        <p>All orders are processed within 5 to 7 business days (excluding weekends and holidays) after receiving your order confirmation email. You will receive another notification when your order has shipped.</p>
                        ...
                        <div class="ms-3">
                            <ul>
                                <li><p>Free Shipping on Pre-paid Orders.</p></li>
                            </ul>
                            <ul>
                                <li><p>Free Shipping on Pre-paid Orders.</p></li>
                            </ul>   
                        ...
                        <p class="fs-2">How do I check the status of my order?</p>
